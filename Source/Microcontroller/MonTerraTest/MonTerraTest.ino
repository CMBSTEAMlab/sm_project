...
const String WIFI_SSID = "CMB STEAMlab"; // replace <WiFi Network Name> with the name of your wifi network
const String WIFI_PSK = "CMBGuest0987";      // replace <WiFi Password> with the password for you wifi network
const encryption WIFI_EE = WPA2;                // If you don't have a password for your wifi network, change WPA2 to NO_SECURITY
const String stationID = "MonTerraTest"; // replace <Station ID> with the a name you want to call your station, using something descriptive!
const String public_key = "mqBpa2Gdg6urqo4XzA6rCGvMeMEJ";
const String private_key = "jLNzWvK07VhDlaeb9x5DCD0jQjmL";
