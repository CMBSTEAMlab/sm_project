...
const String WIFI_SSID = "<ENTER YOUR WIFI NETWORK ID>";
const String WIFI_PSK = "<ENTER YOUR WIFI PASSWORD";

enum encryption{NO_SECURITY, WPA_TKIP, WPA2_AES, WEP};
const encryption WIFI_EE = WPA2_AES; // Change this to the wifi network encryption you are using, leave as WPA2_AES if you're unsure

// When starting your own Phant server, the default port is 8080 and your IP address may be a local 192.168.x.x address
//const String destIP = "192.168.1.122";
//const String destPort = "1F90"; // hex for port 8080

// SparkFun's Phant server (most likely what you will start with) uses port 80 on 54.86.132.254
